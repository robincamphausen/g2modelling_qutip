...
include 'C:/Users/Robin/Anaconda3/lib/site-packages/qutip/cy/complex_math.pxi'
...
def cy_td_ode_rhs(
    ...
    spmvpy(&data0[0], &idx0[0], &ptr0[0], &vec[0], (0 if (t > 100.000000) else _td_array_0[int(round(1000000 * (t/100.000000)))]), out, num_rows)
